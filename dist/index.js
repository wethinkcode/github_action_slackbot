...
async function postMessage() {
    try {
        const token = 'xoxb-1218389585510-1676946893281-JTUxRqIj4pnrLt12vT7ni1UG' //context.getRequired("slack-bot-user-oauth-access-token");
        const channel ='C01N2LRMRTJ'// context.getRequired("slack-channel");
        const func = 'message-send' //context.getRequired('slack-bot-function')
        let file = 'README.md' //context.getOptional('slack-file')
        const text = "@jarmstro I am test" //context.getOptional('slack-message')
